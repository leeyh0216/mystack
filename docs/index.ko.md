...
| Apache Iceberg 1.7.1 GlueCatalog | Create/read/write/evolution, COW/MOR DML, time travel, ref, metadata/maintenance procedure | [Client 호환성 표](compatibility/client-matrix.ko.md) |
