...
| Apache Iceberg 1.7.1 GlueCatalog | Create/read/write/evolution, COW/MOR DML, time travel, refs, metadata/maintenance procedures | [Client compatibility matrix](compatibility/client-matrix.md) |
