...
1. [SQLite runtime](glue-sqlite-runtime.ko.md) — 저장소 보장과 runtime 한계
2. [Database와 table 오류](glue-database-table-errors.ko.md) — catalog validation과 실패
...
Catalog API 변경에는 `glue/tests/`의 boto3 contract를 사용합니다. 전체 public 지원 주장은
