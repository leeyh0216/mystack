...
| [`release/registry-release.json`](release/registry-release.json) | `scripts/release/registry_release.py` | Components, platforms, scanner policy, immutable tags, and publication limits. |
| [`release/version-files.json`](release/version-files.json) | `scripts/release/version.py` | The authoritative list of version-bearing files. |
| [`governance/github-rulesets.json`](governance/github-rulesets.json) | `scripts/release/github_rulesets.py` | Reviewable main/develop branch protection policy. |
